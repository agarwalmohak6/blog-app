# Blog App — React 18 + FastAPI Reference Guide

A full-stack blog application built as a **learning reference** from beginner to advanced.
...
> **No backend?** The app falls back to JSONPlaceholder automatically. Just run the frontend.
